...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/FelipeFFS93")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Felipe Freire", "https://github.com/FelipeFFS93", "felipe_freiresilva@yahoo.com.br");
	}
